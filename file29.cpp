...
1.cbegin() - it refers to the first element of the vector.
2.cend() - it refers to the theoretical element after the last element of the vector.
3.rbegin() - it points to the last element of the vector.
4.rend() - it points to the theoretical element before the first element of the vector.
5.crbegin() - it refers to the last element of the vector.
6.crend() - it refers to the theoretical element before the first element of the vector.
7.max_size() - returns the maximum size the vector can hold.
8.capacity() - it returns the current capacity of the vector.
*/