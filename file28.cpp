...
/*
Other functions:
1. cbegin() – it refers to the first element of the unordered set.
2. cend() – it refers to the theoretical element after the last element of the unordered set.
3. bucket_size() - gives the total number of elements present in a specific bucket in an unordered set.
4. emplace() - to insert an element in the unordered set.
5. max_size() - the maximum elements an unordered_set can hold.
6. max_bucket_count() - to check the maximum number of buckets an unordered set can hold.
*/